    ...
    return (
        <div className="station-edit-modal">
            <div className="edit-details-title">
                <h1>Edit details</h1>
                <button onClick={onCloseStation}><svg role="img" height="16" width="16" aria-label="Close" viewBox="0 0 16 16" className="Svg-ytk21e-0 jAKAlG"><path d="M1.47 1.47a.75.75 0 011.06 0L8 6.94l5.47-5.47a.75.75 0 111.06 1.06L9.06 8l5.47 5.47a.75.75 0 11-1.06 1.06L8 9.06l-5.47 5.47a.75.75 0 01-1.06-1.06L6.94 8 1.47 2.53a.75.75 0 010-1.06z"></path></svg></button>
            </div>
